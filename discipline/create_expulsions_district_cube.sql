-- this is ExpulsionsDistrictCubing-2010-11-19.sql
-- derived from ExpulsionsSchoolCubing-2009-10-03-C.sql

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tblExpulsionsDistricts]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tblExpulsionsDistricts]
GO

select * 
into tblExpulsionsDistricts
from (

	SELECT 
	E.Year, 
	--E.FullKey, 
	'Fullkey' = left(E.[FullKey],6)  + '03XXXX', 
	--A.Schooltype, 
	...
	where 
	--right(E.fullkey,1) <> 'X'
	(A.SMS = '0' or right(E.fullkey,1) = 'X')
	and A.agencytype in ('03','04','4C','49')
	...
	group by E.Year, left(E.[FullKey],6)  + '03XXXX', A.Schooltype, E.Grade, E.Race, E.Sex, E.ldisabled 
	...
	having E.year is not null and (left(E.[FullKey],6) + '03XXXX') is not null 
