...
'ESEA_Core_FTE_Total' = isnull([ESEA_Core_FTE_Total],0),
...
'ESEA_Core_HQYesFTEPercentage' = case cast(isnull([ESEA_Core_FTE_Total],0) as float) when 0 then '--' else cast((case isnull([ESEA_Core_FTE_Total],0) when 0 then 0 else ((isnull([FTE_ESEACore_HQYes],0) / isnull([ESEA_Core_FTE_Total],0)) * 100) end) as char) end,
'FTE_ESEACore_HQNo' = isnull([FTE_ESEACore_HQNo],0),
'ESEA_Core_HQNoFTEPercentage' = case cast(isnull([ESEA_Core_FTE_Total],0) as float) when 0 then '--' else cast((case isnull([ESEA_Core_FTE_Total],0) when 0 then 0 else ((isnull([FTE_ESEACore_HQNo],0) / isnull([ESEA_Core_FTE_Total],0)) * 100) end) as char) end,
--
